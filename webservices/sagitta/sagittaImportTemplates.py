...
sagittaMemoRequestTemplate = """<PassThroughReq><XMLinput><PassThroughReq><XMLinput><Account/><Username/><Password/><Accesscode/><Serverpool/><INPUT><Files><File name="MEMOS"><Items><Item key=""></Item></Items></File></Files></INPUT></XMLinput></PassThroughReq></XMLinput></PassThroughReq>""".strip()
